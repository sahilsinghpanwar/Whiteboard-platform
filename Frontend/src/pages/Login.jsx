      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="z-10 relative">
          <h2 className="text-3xl font-semibold tracking-tight leading-tight max-w-md">
            "Kanvas replaced our whiteboard, our chat, and half our meetings."
          </h2>
          <p className="text-sm text-neutral-400 mt-4 font-mono">— early adopter</p>
        </div>
        <div className="absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_20%_20%,rgba(255,107,53,0.4),transparent_40%)]" />
      </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                data-testid="login-email-input" placeholder="you@company.com" className="h-11" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                data-testid="login-password-input" placeholder="••••••••" className="h-11" />
            </div>
            <Button type="submit" disabled={loading} className="w-full h-11 rounded-lg" data-testid="login-submit-btn">
